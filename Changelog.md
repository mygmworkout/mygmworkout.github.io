...
### Changed
- Flipped the orientation of the on-screen character 180 degrees for all supine leg exercises (Supine Leg Scissors, Parallel Press, Lying Alternating Leg Press, Supine Leg Helicopter, Footwork / Leg Press, Leg Circles, Scissors, Single-Leg Stretch, and The Hundred) to correctly show the head facing the unit and feet pointing away for Pilates loop strap usage.

## [1.1.1] - 2026-06-13

### Changed
- Added orientation instructions to the description of several supine leg exercises (Supine Leg Scissors, Supine Leg Helicopter, Leg Circles, Scissors, Single-Leg Stretch, The Hundred, Parallel Press, and Lying Alternating Leg Press) instructing the user to lay down on their back with their head facing the unit and legs facing away.

...
- Heavily prioritized standard and modern premium US voices (including Zira, Mark, David, Aria, Jenny, Guy, Ana, Christopher, Eric, Michelle, Roger, Steffan, Alex, Susan, Tom, Nathan, Matthew, Salli, Justin, Kendra, Joey, and Ivy) so they float to the top of the dropdown list, while aggressively pushing Apple novelty voices (e.g. Boing, Bubbles, Wobble) to the absolute bottom.
